...
<div class="mt-20 max-w-6xl mx-auto p-6 bg-blue-200 bg-opacity-30 shadow-lg rounded-lg">
    <h2 class="text-2xl font-semibold mb-6 text-center text-blue-900">Tambah Jadwal</h2>
    ...
    <form action="{{ route('schedules.store') }}" method="POST">
        ...
        <button type="submit" class="w-full bg-blue-500 text-white hover:bg-blue-600 transition duration-300 px-4 py-2 rounded-full">Simpan Jadwal</button>
    </form>
</div>
